...
{entry.signature&&<div style={{fontSize:10,color:"#16a34a",fontWeight:600,marginTop:2}}>✍ POD: {entry.signature}</div>}
...
{entry.signature&&<div style={{fontSize:9,color:"#16a34a",fontWeight:600,marginTop:2}}>✍ {entry.signature}</div>}

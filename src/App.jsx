...
import { dedupeIds, dedupeAutoPickups, sanitizeEntry, _mergeEntryDriver, _mergeEntryDispatcher, buildMergedEntries, entrySig, makeTombFilter, vanishedAutoPickups } from "./manifestLogic.js";
    ...
    setLog(prev=>{
      ...
      Object.entries(fbData).forEach(([fbKey,payload])=>{
        ...
        /* Map over FIREBASE entries: the dispatcher is the source of truth for
           ...
           signature fallback is used only when the local signature is unique. */
        const localById={};const localBySig={};const localSigCount={};
        ...
        const merged=fbEnts.map(fbE=>{
          ...
          if(!localE){const s=entrySig(fbE);if(localSigCount[s]===1)localE=localBySig[s];}

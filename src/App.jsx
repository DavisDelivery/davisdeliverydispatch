...
{(()=>{const dels=dl.filter(e=>e.stopType!=="pickup");const n=dels.length;if(n===0)return null;const done=dels.filter(e=>e.status==="departed").length;const un=dels.filter(e=>e.driverId===0).length;return(

...
drvStops[s.driverId].push({pos,routeOrder:s.routeOrder||999});
}
});

/* Detect shared stops across drivers — only show arrows on overlapping routes */
const allDrvPositions={};
Object.entries(drvStops).forEach(([did,items])=>{allDrvPositions[did]=items.sort((a,b)=>a.routeOrder-b.routeOrder).map(i=>i.pos);});

...
<span style={{fontSize:8,color:"#93c5fd",fontWeight:600,opacity:0.7}}>v{APP_VERSION}</span><span style={{display:"inline-block",width:6,height:6,borderRadius:3,background:fbConnected?"#16a34a":"#dc2626",marginLeft:4}}/>

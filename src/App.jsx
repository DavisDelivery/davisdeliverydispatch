...
if(isImg)return<img src={sig} alt="Signature" style={{maxWidth:"100%",maxHeight:200,borderRadius:8,background:"#fff",border:"1px solid #bbf7d0",cursor:"pointer"}} onClick={()=>setLightboxPhoto({src:sig,stop:e.stop,customer:e.customer})}/>;
